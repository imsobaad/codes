  ...
  if(message.content.startsWith(prefix + "giveaway")) {
    ...
    message.channel.send(`:eight_pointed_black_star:| **منشن الروم الذي تريد به القيف اواي**`).then(msgg => {
      message.channel.awaitMessages(filter, {
        ...
        if(!room) return message.channel.send(':heavy_multiplication_x:| **لم يتم العثور على الروم المطلوب**');
        ...
        msgg.edit(':eight_pointed_black_star:| **اكتب مدة القيف اواي**').then(msg => {
          message.channel.awaitMessages(filter, {
            ...
            collected.first().delete();
            msgg.edit(':eight_pointed_black_star:| **اكتب الجائزة اللي تبيها في القيف اواي**').then(msg => {
              message.channel.awaitMessages(filter, {
                max: 1,
                time: 20000,
                errors: ['time']
...
if(!message.guild.member(client.user).hasPermission("MANAGE_ROLES")) return message.reply("**لا تستطيع اعطاء ميوت لاحد الادارة**").then(msg => msg.delete(6000))
...
⤠ *info ⥨ لمعرفة اذا كانت خاصية الرتبة التلقائية مفعلة او لا 
                      **__ملاحظة__**
و تخلي رتبة البوت فوقها Memberعشان يشتغل الامر لازم تسوي رتبة باسم
`)
...
client.on('guildMemberAdd', eyad => {
  let channel = eyad.guild.channels.find('name', 'logs');
      ...
      .then(audit => {
        ...
        try {
          ...
          let embed = new Discord.RichEmbed()
            ...
            .addField('ايدي الرول :', role.id, true)
    ...
    cc.guild.fetchAuditLogs({
      ...
      .then(audit => {
        ...
        try {
          ...
          let log = cc.guild.channels.find('name', 'logs');
          if (!log) return;
          let embed = new Discord.RichEmbed()
            .setColor('#fd0101')            
            .setTitle('➕ ChannelCreated')
            .addField('اسم الروم :', role.name, true)
            .addField('أيدي الروم :', role.id, true)
            .addField('بواسطة :', exec, true)
            .setTimestamp()
          log.send(embed).catch(e => {
            console.log(e);
    ...
    dc.guild.fetchAuditLogs({
      ...
      .then(audit => {
        ...
        try {
          ...
          let log = dc.guild.channels.find('name', 'logs');
          if (!log) return;
          let embed = new Discord.RichEmbed()
            .setColor('#fd0101')            
...
client.on('voiceStateUpdate', (oldM, newM) => {
  ...
  if(!ch) return;
    ...
    if(m1 === false && m2 === true) {
       ...
       .setDescription(`${newM} تم اعطاء ميوت صوتي ل`)
    ...
    if(m1 === true && m2 === false) {
       let embed = new Discord.RichEmbed()
       .setAuthor(`${newM.user.tag}`, newM.user.avatarURL)
       .setDescription(`${newM} تم فك الميوت الصوتي عن`)
       .setFooter(`بواسطة : ${user}`)
       .setTimestamp()
    ...
    if(d1 === false && d2 === true) {
       let embed = new Discord.RichEmbed()
       .setAuthor(`${newM.user.tag}`, newM.user.avatarURL)
       .setDescription(`${newM} تم غلق سماعات عن`)
       .setFooter(`بواسطة : ${user}`)
       .setTimestamp()
    ...
    if(d1 === true && d2 === false) {
       let embed = new Discord.RichEmbed()
       .setAuthor(`${newM.user.tag}`, newM.user.avatarURL)
       .setDescription(`${newM} تم فتح السماعات عن`)
       .setFooter(`بواسطة : ${user}`)
       .setTimestamp()
  ...
  client.setTimeout(() => {
    guild.fetchAuditLogs({
      ...
      .then(audit => {
        ...
        .addField('- العضو الذي تم تبنيده :',`**${myUser.username}**`,true)
        .addField('- بواسطة :',`**${exec}**`,true)
        ...
        .then(audit => {
          ...
          try {
            ...
            let embed = new Discord.RichEmbed()
              ...
              .addField("ايدي الرول",`${re.id}`,true )
              .addField('بواسطة', exec, true)
              .setTimestamp()
            log.send(embed).catch(e => {
              console.log(e);
