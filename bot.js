...
client.on('message',async message => {
    ...
    message.guild.createChannel(`DarknessOnline : ${message.guild.members.filter(m => m.voiceChannel).size}.` , 'voice').then(c => {
      ...
      setInterval(function() {
        c.setName(`DarknessOnline : ${message.guild.members.filter(m => m.voiceChannel).size}.`)
      },1000);
    });
    }
  });
...
client.on('message', message => {
      ...
      if (!message.channel.guild) return;
    message.channel.sendFile('https://e.top4top.net/p_979czndu1.png');
  }
